/*=========================================================================
  ...
  Module:    vtkVgArcParallelEdgeStrategy.cxx
...
vtkStandardNewMacro(vtkVgArcParallelEdgeStrategy);

vtkVgArcParallelEdgeStrategy::vtkVgArcParallelEdgeStrategy()
{
  this->NumberOfSubdivisions = 10;
  this->MinLoopHeight = 0.1;
  this->MaxLoopHeight = 1.0;
}
...
void vtkVgArcParallelEdgeStrategy::Layout()
{
  ...
  for (vtkIdType eid = 0; eid < numEdges; ++eid)
    ...
    if (dist == 0)
      {
      double radius = this->MinLoopHeight +
                      (this->MaxLoopHeight - this->MinLoopHeight) * cur / total;
...
void vtkVgArcParallelEdgeStrategy::PrintSelf(ostream& os, vtkIndent indent)
{
