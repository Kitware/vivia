...
class QTVG_WIDGETS_EXPORT ctkRangeSlider : public QSlider
{
  Q_OBJECT
  ...
  Q_PROPERTY(bool minHandleShown READ minHandleShown WRITE setMinHandleShown)
...
public:
  ...
  /// VISGUI specific:
  /// Hide or show the min handle. Hidden by default.
  bool minHandleShown()const;
  void setMinHandleShown(bool enabled);
