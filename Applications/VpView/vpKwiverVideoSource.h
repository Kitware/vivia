...
public:
  ...
  virtual bool next_frame(kwiver::vital::time_usec_t timeout = 0) override;
  virtual bool seek_frame(kwiver::vital::timestamp::frame_t frame_number,
                          kwiver::vital::time_usec_t timeout = 0) override;
  virtual bool seek_time(kwiver::vital::timestamp::time_t time_usec,
                         kwiver::vital::time_usec_t timeout = 0) override;
