...
//-----------------------------------------------------------------------------
qtSettings_implement(databaseHostname,        DatabaseHostname,        QUrl)
qtSettings_implement(databaseServerPort,      DatabaseServerPort,      QString)
qtSettings_implement(databaseDriver,          DatabaseDriver,          QString)
qtSettings_implement(databaseName,            DatabaseName,            QString)
qtSettings_implement(databaseUsername,        DatabaseUsername,        QString)
qtSettings_implement(databaseUseSourceImages, DatabaseUseSourceImages, bool)
qtSettings_implement(coordinateDisplayMode_,  CoordinateDisplayMode_,  QString)
qtSettings_implement(imageFilteringMode_,     ImageFilteringMode_,     QString)
qtSettings_implement(trackTrailLengthFrames,  TrackTrailLengthFrames,  int)
qtSettings_implement(trackTrailLengthSeconds, TrackTrailLengthSeconds, double)
qtSettings_implement(useTimeStampData,        UseTimeStampData,        bool)
qtSettings_implement(forceFrameBasedVideoControls,
                     ForceFrameBasedVideoControls, bool)
qtSettings_implement(worldDisplayEnabled,     WorldDisplayEnabled,     bool)
qtSettings_implement(translateImageEnabled,   TranslateImageEnabled,   bool)
qtSettings_implement(useZeroBasedFrameNumbers,UseZeroBasedFrameNumbers,bool)
qtSettings_implement(streamingUpdateInterval, StreamingUpdateInterval, int)
qtSettings_implement(streamingTrackUpdateChunkSize,
                     StreamingTrackUpdateChunkSize, int)
qtSettings_implement(rightClickToEdit,        RightClickToEdit,        bool)
qtSettings_implement(autoAdvanceDuringCreation,AutoAdvanceDuringCreation,bool)
qtSettings_implement(sceneElementLineWidth,   SceneElementLineWidth,   double)

qtSettings_implement(videoPlaybackMode_,      VideoPlaybackMode_,      QString)
qtSettings_implement(videoSuggestedFps,       VideoSuggestedFps,       double)

qtSettings_implement(externalProcessProgram,  ExternalProcessProgram,  QString)
qtSettings_implement(externalProcessArgs,     ExternalProcessArgs,     QStringList)
qtSettings_implement(externalProcessIOPath,   ExternalProcessIOPath,     QString)
qtSettings_implement(externalProcessThreshold,   ExternalProcessThreshold,     double)
qtSettings_implement(externalProcessThresholdState,   ExternalProcessThresholdState,     bool)
qtSettings_implement(externalProcessCellSize,   ExternalProcessCellSize,     double)
qtSettings_implement(externalProcessCellSizeState,   ExternalProcessCellSizeState,     bool)
